 ...
 *group by result
 *
 * Generated from protobuf message <code>aliyun.OTS.ProtoBuffer.Protocol.GroupByFieldResultItem</code>
 */
class GroupByFieldResultItem extends \Aliyun\OTS\ProtoBuffer\Protocol\Message
{
    /**
