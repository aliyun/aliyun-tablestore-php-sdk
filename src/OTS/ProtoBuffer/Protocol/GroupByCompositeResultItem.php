...
/**
 * Generated from protobuf message <code>aliyun.OTS.ProtoBuffer.Protocol.GroupByCompositeResultItem</code>
 */
class GroupByCompositeResultItem extends \Aliyun\OTS\ProtoBuffer\Protocol\Message
{
    /**
     * Generated from protobuf field <code>repeated string keys = 1;</code>
     */
    private $keys;
    private $has_keys = false;
    /**
