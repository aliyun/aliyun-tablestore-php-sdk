...
/**
 * Generated from protobuf message <code>aliyun.OTS.ProtoBuffer.Protocol.GroupByGeoGridResultItem</code>
 */
class GroupByGeoGridResultItem extends \Aliyun\OTS\ProtoBuffer\Protocol\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>optional .aliyun.OTS.ProtoBuffer.Protocol.GeoGrid geo_grid = 2;</code>
     */
    private $geo_grid = null;
    private $has_geo_grid = false;
    /**
    ...
    /**
     * Generated from protobuf field <code>optional .aliyun.OTS.ProtoBuffer.Protocol.GeoGrid geo_grid = 2;</code>
     * @return \Aliyun\OTS\ProtoBuffer\Protocol\GeoGrid
     */
    public function getGeoGrid()
    {
        return $this->geo_grid;
    }

    /**
     * Generated from protobuf field <code>optional .aliyun.OTS.ProtoBuffer.Protocol.GeoGrid geo_grid = 2;</code>
     * @param \Aliyun\OTS\ProtoBuffer\Protocol\GeoGrid $var
     * @return $this
     */
    public function setGeoGrid($var)
    {
        GPBUtil::checkMessage($var, \Aliyun\OTS\ProtoBuffer\Protocol\GeoGrid::class);
        $this->geo_grid = $var;
        $this->has_geo_grid = true;

        return $this;
    }

    public function hasGeoGrid()
    {
        return $this->has_geo_grid;
    }
