 ...
 *single agg result
 *
 * Generated from protobuf message <code>aliyun.OTS.ProtoBuffer.Protocol.AvgAggregationResult</code>
 */
class AvgAggregationResult extends \Aliyun\OTS\ProtoBuffer\Protocol\Message
{
    /**
